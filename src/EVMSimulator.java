...
public class EVMSimulator {
    ...
    private void exe_instr(BasicBlock currentBlock, Pair<Integer, Pair<String, String>> instr_pair,
            LinkedList<String> evm_stack) {
        ...
        if (instr.equals("JUMP")) {
            if (evm_stack.size() >= 1) {
                ...
                if (Utils.getType(address) == Utils.DIGITAL) {
                    ...
                    if (jumpPos == 0 || !this.pos2BlockMap.containsKey(jumpPos)) {
                        ...
                        legalJump = true;
                        versionGap = true;
                    } else if (this.pos2BlockMap.get(jumpPos).instrList.get(0).getSecond().getFirst()
                            .equals("JUMPDEST")) {
            ...
            int dupPos = Integer.parseInt(dp.trim());
