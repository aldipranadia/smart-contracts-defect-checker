...
public class Utils {
    ...
    public static String getDisasmCode(String binary) throws Exception {
        String disasmCode = "";
        String disasmCodeHard = readFileAsString(
                "D:/Kuliah/.S2/.Tugas Kuliah/Semester 3/PPT/DefectChecker-master/DefectChecker/disasmcode.txt");
        ...
        try {
            ...
            writer.flush();
            writer.close();
            disasmCode = disasmCodeHard;
            // disasmCode = runCMDWithTimeout(new String[] { "evm-1.8.14", "disasm",
            // tmp.getAbsolutePath() });
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public static Long Hex2Long(String hex) {
        if (hex.length() < 1)
            return 0L;
        Long parseLong = Long.parseLong(hex.trim(), 16);
        return parseLong;
    }
    ...
    public static Pair<String, String> splitInstr2(String instr) {
        ...
        // EXAMPLE1:
        // EQ_1210(AND_1186(PUSH20_1165,AND_1164(PUSH20_1143,DIV_1142(SLOAD_1135(0_1131),1_1140))),AND_1209(PUSH20_1188,ORIGIN_1187))
        // EXAMPLE2: EQ_1210(PUSH20_1165,AND_1209(PUSH20_1188,ORIGIN_1187))
        // EXAMPLE3: AND_1209(PUSH20_1188,ORIGIN_1187)
        // EXAMPLE4:
        // EQ_1210(AND_1186(PUSH20_1165,AND_1164(PUSH20_1143,DIV_1142(SLOAD_1135(0_1131),1_1140))),PUSH20_1165)
        int flag = 0;
        int startPos = -1;
        int splitPos = -1;
        int endPos = -1;
    ...
    public static void printAnswerCheck(ArrayList<Boolean> groundTruth, DefectChecker defectChecker) {
        // 0. Uncheck External Calls 1. Strict Balance Equality 2. Transaction State
        // Dependency 3. Block Info Dependency
